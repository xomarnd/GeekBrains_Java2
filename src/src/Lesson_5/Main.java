...
public class Main {
    ...
    private void methodTwo(){
        ...
        Thread thread1 = new Thread(() ->this.methodTwoCalculate (arr1, 1));
        Thread thread2 = new Thread(() ->this.methodTwoCalculate (arr2, 2));
    ...
    private void methodTwoCalculate(float[] arr, int number){
        long start = System.currentTimeMillis();
        calculate(arr);
        long end = System.currentTimeMillis();
